...
public class SequenceAdapter extends BaseExpandableListAdapter {
    ...
    public View getGroupView(int groupPosition, boolean isExpanded,
        ...
        convertView = (LinearLayout) LinearLayout.inflate(context,
                R.layout.activity_sequence_item, null);
        ...
        if (isExpanded) {
            group_title.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                    R.drawable.ic_sequence_group_down, 0);
        } else {
            group_title.setCompoundDrawablesWithIntrinsicBounds(0, 0,
                    R.drawable.ic_sequence_group_up, 0);
        }
    ...
    public View getChildView(int groupPosition, int childPosition,
        ...
        convertView = (RelativeLayout) RelativeLayout.inflate(context,
                R.layout.activity_sequence_subitem, null);
